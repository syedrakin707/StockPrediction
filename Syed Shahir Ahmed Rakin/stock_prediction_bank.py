...
axs1[0].plot(range(00,train_len+futureTotal),dfabbank[00:train_len+futureTotal],'b',label="Original Data (AB Bank)", alpha=0.3)
...
axs1[1].plot(range(00,train_len+futureTotal),dfbankasia[00:train_len+futureTotal],'y',label="Original Data (Bank Asia)", alpha=0.3)
#plt.plot(range(0,train_len),pred_training,'.g',  alpha=0.3)
axs1[1].plot(range(train_len,train_len+futureTotal),pred_tot_bankasia,'r',  alpha=0.8, label='Post ESN Data (Bank Asia)')
lo,hi = plt.ylim()
axs1[0].plot([train_len,train_len],[lo+np.spacing(1),hi-np.spacing(1)],'b--', linewidth=4)
axs1[1].plot([train_len,train_len],[lo+np.spacing(1),hi-np.spacing(1)],'r--', linewidth=4)
...
axs2[0].plot(range(00,train_len+futureTotal),dfific[00:train_len+futureTotal],'b',label="Original Data (IFIC)", alpha=0.4)
#plt.plot(range(0,train_len),pred_training,'.g',  alpha=0.3)
axs2[0].plot(range(train_len,train_len+futureTotal),pred_tot_ific,'k',  alpha=0.8, label='Post ESN Data (IFIC)')

axs2[1].plot(range(00,train_len+futureTotal),dfjamunabank[00:train_len+futureTotal],'y',label="Original Data (Jamuna Bank)", alpha=0.7)
#plt.plot(range(0,train_len),pred_training,'.g',  alpha=0.3)
axs2[1].plot(range(train_len,train_len+futureTotal),pred_tot_jamunabank,'r',  alpha=0.8, label='Post ESN Data (Jamuna Bank)')
lo,hi = plt.ylim()
axs2[0].plot([train_len,train_len],[lo+np.spacing(1),hi-np.spacing(1)],'b--', linewidth=4)
axs2[1].plot([train_len,train_len],[lo+np.spacing(1),hi-np.spacing(1)],'r--', linewidth=4)
...
axs2[0].plot(range(00,train_len+futureTotal),dfmtb[00:train_len+futureTotal],'b',label="Original Data (MTB)", alpha=0.4)
#plt.plot(range(0,train_len),pred_training,'.g',  alpha=0.3)
axs2[0].plot(range(train_len,train_len+futureTotal),pred_tot_mtb,'k',  alpha=0.8, label='Post ESN Data (MTB)')

axs2[1].plot(range(00,train_len+futureTotal),dfnccbank[00:train_len+futureTotal],'y',label="Original Data (NCC Bank)", alpha=0.7)
#plt.plot(range(0,train_len),pred_training,'.g',  alpha=0.3)
...
axs2[0].plot(range(00,train_len+futureTotal),dfsoutheast[00:train_len+futureTotal],'b',label="Original Data (South East Bank)", alpha=0.4)
#plt.plot(range(0,train_len),pred_training,'.g',  alpha=0.3)
axs2[0].plot(range(train_len,train_len+futureTotal),pred_tot_southeast,'k',  alpha=0.8, label='Post ESN Data (South East Bank)')

axs2[1].plot(range(00,train_len+futureTotal),dfucb[00:train_len+futureTotal],'y',label="Original Data (UCB)", alpha=0.7)
#plt.plot(range(0,train_len),pred_training,'.g',  alpha=0.3)
...
axs2[0].plot(range(00,train_len+futureTotal),dfebl[00:train_len+futureTotal],'b',label="Original Data (EBL)", alpha=0.4)
#plt.plot(range(0,train_len),pred_training,'.g',  alpha=0.3)
axs2[0].plot(range(train_len,train_len+futureTotal),pred_tot_ebl,'k',  alpha=0.8, label='Post ESN Data (EBL)')

axs2[1].plot(range(00,train_len+futureTotal),dfdutchbangl[00:train_len+futureTotal],'y',label="Original Data (DBBL)", alpha=0.7)
#plt.plot(range(0,train_len),pred_training,'.g',  alpha=0.3)
